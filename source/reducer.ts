...
export function on<C extends ActionCreator, S>(creator: C, reducer: OnReducer<S, [C]>): { reducer: On<S>, types: string[] };
export function on<C extends ActionCreator[], S>(creators: C, reducer: OnReducer<S, C>): { reducer: On<S>, types: string[] };
export function on(
