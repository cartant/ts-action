...
export function on<C extends ActionCreator<string, Creator>, S>(creator: C, reducer: (state: S, action: ActionType<C>) => S): { reducer: On<S>, types: string[] };
export function on<C extends ActionCreator<string, Creator>[], S>(creators: C, reducer: (state: S, action: ActionType<C[number]>) => S): { reducer: On<S>, types: string[] };
export function on(
    c: ActionCreator<string, Creator> | ActionCreator<string, Creator>[],
    reducer: Function
